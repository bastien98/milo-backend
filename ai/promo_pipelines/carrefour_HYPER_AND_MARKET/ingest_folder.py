#!/usr/bin/env python3
"""
Carrefour Belgium Promo Folder Ingestion Pipeline (Hyper + Market)
...
This pipeline is for promotions valid at both Carrefour Hypermarkets AND participating
Carrefour Market stores.

Usage (from scandelicious-backend/):
    python ai/promo_pipelines/carrefour_HYPER_AND_MARKET/ingest_folder.py promo_folder_carrefour.pdf
    python ai/promo_pipelines/carrefour_HYPER_AND_MARKET/ingest_folder.py promo_folder_carrefour.pdf --dry-run
"""
...
RETAILER_NAME = "Carrefour Hypermarkt en deelnemende Carrefour Markets"
RETAILER_DISPLAY_NAME = "Carrefour Hypermarkt en deelnemende Carrefour Markets"
...
def main():
    ...
    logger.info("=" * 60)
    logger.info(f"{RETAILER_DISPLAY_NAME} Promo Folder Ingestion Pipeline (Hyper + Market)")
    logger.info("=" * 60)
